...
export const SUNFORGE_DEF = {
  ...
  points: [
    { x: -202, y: 0,    z: -162, w: 26 },
    { x: -27,  y: 0,    z: -162, w: 26 },
    { x: 105,  y: 0,    z: -157, w: 22 },
    { x: 205,  y: 1.5,  z: -140, w: 17 },
    { x: 267,  y: 3,    z: -84,  w: 15 },
    { x: 224,  y: 5.5,  z: 11,   w: 15 },
    { x: 178,  y: 9.5,  z: 186,  w: 14 },
    { x: 81,   y: 12,   z: 251,  w: 13 },
    { x: -41,  y: 11.5, z: 273,  w: 13 },
    { x: -162, y: 8.5,  z: 259,  w: 12 },
    { x: -232, y: 5.5,  z: 200,  w: 11.5 },
    { x: -259, y: 3.5,  z: 105,  w: 11 },
    { x: -230, y: 2.5,  z: 14,   w: 11 },
    { x: -273, y: 1.5,  z: -73,  w: 12 },
    { x: -267, y: 0.5,  z: -140, w: 18 },
  ],
  shortcut: { entry: 0.805, exit: 0.885, latEntry: 3.4, latExit: 4.6, halfW: 3.6 },
  ramps: [
    { f: 0.40, len: 14, lat: 0, halfW: 4.2, rise: 2.6 },
    { f: 0.59, len: 10, lat: 0, halfW: 4.0, rise: 1.8 },
    { f: 0.058, len: 9, lat: -3.5, halfW: 3.5, rise: 1.4 },
  ],
  pads: [
    { f: 0.13, lat: 3, halfW: 2.3, len: 5 },
    { f: 0.13, lat: -3, halfW: 2.3, len: 5 },
    { f: 0.375, lat: 0, halfW: 2.6, len: 5 },
    { f: 0.555, lat: 0, halfW: 2.6, len: 5 },
    { f: 0.935, lat: 0, halfW: 2.6, len: 5 },
  ],
  checkpoints: [0, 0.10, 0.355, 0.385, 0.53, 0.625, 0.712, 0.765, 0.905, 0.965],
  cpExtras: { 0: 6, 8: 14 },
  obstacles: [
    { type: 'gear', s: 0.84, lat: 2.0, armRadius: 6.4, speed: 0.85 },
    { type: 'slider', s: 0.645, ampExtra: 0.8, speed: 2.2, radius: 1.6 },
  ],
  zones: [],
...
export const TRACK_DEFS = [
  ...
  // ------------------------------------------------------------------ desert
  {
    ...
    points: [
      { x: -160, y: 0, z: -120, w: 24 },
      { x: 40,  y: 0, z: -150, w: 22 },
      { x: 185, y: 2, z: -115, w: 16 },
      { x: 245, y: 4, z: -10, w: 13 },
      { x: 195, y: 3, z: 95,  w: 14 },
      { x: 60,  y: 1, z: 150, w: 18 },
      { x: -60, y: 0, z: 165, w: 15 },
      { x: -130, y: 1, z: 105, w: 11.5 },   // chicane mouth
      { x: -95, y: 2, z: 50,  w: 11 },
      { x: -160, y: 3, z: -5, w: 11 },
      { x: -215, y: 2, z: -65, w: 15 },
    ],
    shortcut: { entry: 0.52, exit: 0.62, latEntry: -3.0, latExit: -3.6, halfW: 3.4 },
    ramps: [
      { f: 0.18, len: 12, lat: 0, halfW: 4.0, rise: 2.2 },
      { f: 0.70, len: 9, lat: 2.5, halfW: 3.2, rise: 1.5 },
    ],
    pads: [
      { f: 0.08, lat: 0, halfW: 2.6, len: 5 },
      { f: 0.42, lat: 0, halfW: 2.4, len: 5 },
      { f: 0.90, lat: 0, halfW: 2.6, len: 5 },
    ],
    checkpoints: [0, 0.11, 0.27, 0.40, 0.56, 0.66, 0.78, 0.88, 0.955],
    cpExtras: { 0: 6, 5: 13 },
    obstacles: [{ type: 'slider', s: 0.34, ampExtra: 0.6, speed: 2.6, radius: 1.5 }],
    zones: [],
    boxes: [0.05, 0.24, 0.47, 0.68, 0.86],
  ...
  // ------------------------------------------------------------------ forest
  {
    ...
    points: [
      { x: -180, y: 0, z: -140, w: 22 },
      { x: 0,   y: 0, z: -170, w: 20 },
      { x: 150, y: 2, z: -140, w: 16 },
      { x: 225, y: 5, z: -40, w: 13.5 },
      { x: 150, y: 7, z: 60,  w: 13 },
      { x: 20,  y: 6, z: 90,  w: 13.5 },
      { x: -65, y: 4, z: 55,  w: 13 },
      { x: -125, y: 3, z: 110, w: 13.5 },
      { x: -55, y: 2, z: 175, w: 15 },
      { x: -185, y: 1, z: 150, w: 16 },
      { x: -245, y: 0, z: 30,  w: 17 },
    ],
    shortcut: { entry: 0.44, exit: 0.55, latEntry: 2.8, latExit: 3.2, halfW: 3.2 },
    ramps: [{ f: 0.30, len: 10, lat: 0, halfW: 3.8, rise: 1.9 }],
    pads: [
      { f: 0.12, lat: 2.5, halfW: 2.3, len: 5 },
      { f: 0.12, lat: -2.5, halfW: 2.3, len: 5 },
      { f: 0.62, lat: 0, halfW: 2.5, len: 5 },
      { f: 0.92, lat: 0, halfW: 2.6, len: 5 },
    ],
    checkpoints: [0, 0.10, 0.24, 0.36, 0.50, 0.63, 0.76, 0.88, 0.955],
    cpExtras: { 0: 6, 5: 12 },
    obstacles: [{ type: 'pendulum', s: 0.70, lat: 0, swing: 5.6, speed: 1.15, radius: 1.4 }],
    zones: [{ f0: 0.30, f1: 0.42, type: 'slippery', v: 0.55 }],   // moss slicks
    boxes: [0.06, 0.22, 0.45, 0.66, 0.85],
  ...
  // -------------------------------------------------------------- neon city
  {
    ...
    points: [
      { x: -200, y: 0, z: -160, w: 24 },
      { x: 60,  y: 0, z: -160, w: 20 },
      { x: 200, y: 0, z: -150, w: 15 },    // hard 90° right
      { x: 205, y: 4, z: -20, w: 13.5 },
      { x: 120, y: 6, z: 40,  w: 12.5 },
      { x: 205, y: 10, z: 120, w: 12.5 },
      { x: 60,  y: 12, z: 180, w: 13.5 },
      { x: -80, y: 10, z: 185, w: 14 },
      { x: -200, y: 6, z: 120, w: 14.5 },
      { x: -260, y: 3, z: 0,  w: 15 },
      { x: -260, y: 1, z: -90, w: 18 },
    ],
    ramps: [
      { f: 0.20, len: 11, lat: 0, halfW: 3.6, rise: 2.4 },
      { f: 0.56, len: 9, lat: 0, halfW: 3.4, rise: 2.0 },
    ],
    pads: [
      { f: 0.10, lat: 0, halfW: 2.6, len: 5 },
      { f: 0.47, lat: 0, halfW: 2.4, len: 4.5 },
      { f: 0.80, lat: 0, halfW: 2.6, len: 5 },
    ],
    checkpoints: [0, 0.09, 0.18, 0.30, 0.42, 0.55, 0.68, 0.80, 0.91, 0.965],
    cpExtras: { 0: 6 },
    obstacles: [{ type: 'slider', s: 0.735, ampExtra: 0.5, speed: 2.8, radius: 1.4 }],
    zones: [],
...

  {
    ...
    points: [
      { x: -170, y: 0,  z: -120, w: 18 },
      { x: 0,   y: 2,  z: -170, w: 16 },
      { x: 150, y: 5,  z: -120, w: 14 },
      { x: 190, y: 9,  z: 10,   w: 13 },
      { x: 130, y: 13, z: 130,  w: 12.5 },
      { x: 0,   y: 16, z: 175,  w: 12 },
    ...
    pads: [
      { f: 0.15, lat: 0, halfW: 2.4, len: 5 },
      { f: 0.60, lat: 0, halfW: 2.4, len: 5 },
      { f: 0.95, lat: 0, halfW: 2.5, len: 5 },
    ],
    checkpoints: [0, 0.11, 0.24, 0.37, 0.50, 0.62, 0.74, 0.87, 0.95],
    cpExtras: { 0: 6, 8: 12 },
    obstacles: [{ type: 'gear', s: 0.56, lat: -1.5, armRadius: 5.2, speed: 1.0 }],
    zones: [],
    boxes: [0.07, 0.30, 0.52, 0.72, 0.90],
    ranges: {},
  },
