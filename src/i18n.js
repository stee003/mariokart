...
const BASE_STRINGS = {
  ...
  'settings.control.gamepad': { en: 'Controller priority',            it: 'Priorità controller' },
  'settings.touchLayout': { en: 'Touch layout',                      it: 'Schema touch' },
  'settings.layout.joystick': { en: 'Virtual stick',                 it: 'Leva virtuale' },
  'settings.layout.buttons': { en: 'Direction buttons',              it: 'Pulsanti direzionali' },
  'settings.gamepadHint': { en: 'Bluetooth controllers are supported. Connect a standard Xbox, PlayStation or Switch-style gamepad.',
                            it: 'I controller Bluetooth sono supportati. Collega un gamepad standard Xbox, PlayStation o Switch.' },
  'settings.gamepadConnected': { en: 'Controller connected',         it: 'Controller collegato' },
  'settings.gamepadNotConnected': { en: 'No controller detected',    it: 'Nessun controller rilevato' },
  'settings.gamepadFallback': { en: 'No controller found — touch controls are active until one connects.',
                                it: 'Nessun controller rilevato: i comandi touch restano attivi finché non si collega.' },
  'settings.fullscreen': { en: 'Fullscreen',                        it: 'Schermo intero' },
  'display.fullscreen': { en: 'Enter fullscreen',                    it: 'Attiva schermo intero' },
  'display.exitFullscreen': { en: 'Exit fullscreen',                 it: 'Esci da schermo intero' },
  'display.fullscreenUnsupported': { en: 'Fullscreen is not available in this browser. Try Add to Home Screen for an app-like view.',
                                     it: 'Lo schermo intero non è disponibile in questo browser. Prova Aggiungi a Home per una visuale app.' },
  'display.fullscreenFailed': { en: 'The browser could not enter fullscreen.',
                                it: 'Il browser non è riuscito ad attivare lo schermo intero.' },
  'touch.controls': { en: 'Touch controls',                        it: 'Comandi touch' },
  'touch.joystick': { en: 'Virtual stick: steer left or right, push up to accelerate and down to brake',
                      it: 'Leva virtuale: sterza a sinistra o destra, spingi su per accelerare e giù per frenare' },
  'touch.directionPad': { en: 'Directional driving buttons',        it: 'Pulsanti direzionali di guida' },
  'touch.gameplayActions': { en: 'Race actions',                   it: 'Azioni di gara' },
  'touch.drift': { en: 'DRIFT',                                    it: 'DERAPATA' },
  'touch.item': { en: 'ITEM',                                      it: 'OGGETTO' },
  'touch.trick': { en: 'TRICK',                                    it: 'ACROBAZIA' },
  'touch.reset': { en: 'RESET',                                    it: 'RESET' },
  'touch.accelerate': { en: 'Accelerate',                          it: 'Accelera' },
  'touch.brake': { en: 'Brake',                                    it: 'Frena' },
  'touch.pause': { en: 'Pause',                                    it: 'Pausa' },
  'touch.fullscreen': { en: 'Toggle fullscreen',                    it: 'Attiva/disattiva schermo intero' },
  ...
  'controls.mobile':   { en: 'Touch controls are ready · connect a Bluetooth gamepad or choose a touch layout in Settings',
                         it: 'Comandi touch pronti · collega un gamepad Bluetooth o scegli lo schema touch nelle Impostazioni' },
  'controls.gamepad':  { en: 'Controller: RT throttle · LT brake · stick steer · X drift · Y item · A trick · START pause',
                         it: 'Controller: RT accelera · LT frena · leva sterza · X derapata · Y oggetto · A acrobazia · START pausa' },
